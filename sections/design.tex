...
An RTP packet is depicted in figure~\ref{fig:design:rtppacket}:
...
The packet type identifies the format of the payload. RFC3550 lists some static assignments for historical reasons \citep{perkins2003rtp}, but usually 96 is used, as it denotes the payload is dynamic. This means the format of the payload must be specified in the SDP, as described in section \ref{sec:design:sdp}.


\section{Profile} \label{sec:design:profile}
