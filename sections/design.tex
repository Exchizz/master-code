...
\noindent At last, the following requirements should be used.
...
As stated in section \ref{sec:design:essentalmetadata}, an RTCP SR packet must be sent periodically by the \pub{}, in order to timestamp the source stream.
