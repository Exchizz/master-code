...
\myparagraph{Events}
Given that the \pub{} must be implement using an event loop, the \pub{} must implement the following events:
...
As with the \pub{}, the \sub{} must also implement an event loop. The \sub{} should implement the following events:
