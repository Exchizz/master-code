...
\begin{enumerate}
    ...
    \item Each stream must have its own multicast group. \todo{But one group might have multiple streams}
	...
	\item A stream must support referring to its parent streams.
\end{enumerate}
...
\begin{enumerate}
	...
	\item The \pub{} must be agnostic to the stream's payload.
